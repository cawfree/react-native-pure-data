...
const unregisterAudioController = audioControllerId => Promise
  .resolve()
  .then(() => nativeUnregisterAudioController(audioControllerId));

const unregisterPatch = (audioControllerId, patchId) => Promise
  .resolve()
  .then(() => nativeUnregisterPatch(audioControllerId, patchId));
